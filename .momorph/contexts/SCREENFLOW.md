...
flowchart TD
    ...
    subgraph Kudos["Kudos Flow"]
        WriteKudo[Viet Kudo / Gui loi chuc]
        ViewKudo[View Kudo]
        EditKudo[Man Sua bai viet]
    end
    ...
    subgraph Awards["Awards & Titles"]
        Award[Award / He thong giai]
        Titles[Danh hieu]
    end

    subgraph SecretBox["Secret Box / Giftbox"]
        OpenSecretBox[Open secret box]
        OpenGiftbox[Open Giftbox]
    end

    subgraph ErrorPages["Error Pages"]
        Error403[Error page - 403]
    ...
    HomepageSAA --> SunKudosLiveBoard
    HomepageSAA --> Notification
    HomepageSAA --> ProfileSelf
    HomepageSAA --> Award
...
flowchart LR
    ...
    Homepage -->|GET /kudos| KudosAPI
    KudosFeed -->|POST /kudos| KudosAPI
    Profile -->|GET /users/me| UserAPI
    Admin -->|GET /admin/*| AdminAPI
    LanguageDropdown -->|PUT /users/me/language| UserAPI
    UserAPI --> DB
    KudosAPI --> DB
    AdminAPI --> DB
    NotifAPI --> DB
