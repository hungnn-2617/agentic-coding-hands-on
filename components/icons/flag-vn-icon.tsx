interface FlagVnIconProps {
  className?: string;
}

export function FlagVnIcon({ className }: FlagVnIconProps) {
  return (
    <svg
      width="24"
      height="24"
